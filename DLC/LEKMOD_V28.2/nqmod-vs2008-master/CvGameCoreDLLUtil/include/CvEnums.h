...
enum MiniCompetitionTypes
{
	...
	COMPETITION_DIPLOMATIC_START,

	COMPETITION_TRADE_ROUTES_MOST_INTERNATIONAL = COMPETITION_DIPLOMATIC_START,
	COMPETITION_ALLIES,

	COMPETITION_DIPLOMATIC_END = 5,
	COMPETITION_CULTURE_START = COMPETITION_DIPLOMATIC_END,

	COMPETITION_CULTURE_END = 10,
	COMPETITION_SCIENCE_START = COMPETITION_CULTURE_END,

	COMPETITION_SCIENCE_END = 15,
