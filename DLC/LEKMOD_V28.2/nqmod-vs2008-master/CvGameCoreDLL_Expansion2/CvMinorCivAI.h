...
#define QUEST_UNREST MINOR_CIV_QUEST_KILL_CAMP
#define QUEST_BUILD_WORLD_WONDER MINOR_CIV_QUEST_CONSTRUCT_WONDER
#define QUEST_GIFT_GREAT_PERSON MINOR_CIV_QUEST_GREAT_PERSON

#define QUEST_BUILD_NATIONAL_WONDER MINOR_CIV_QUEST_FIND_NATURAL_WONDER
#define QUEST_GIFT_GOLD MINOR_CIV_QUEST_GIVE_GOLD
#define QUEST_GIFT_MILITARY MINOR_CIV_QUEST_PLEDGE_TO_PROTECT

#define QUEST_GIFT_WORKER MINOR_CIV_QUEST_CONTEST_CULTURE
#define QUEST_SPREAD_RELIGION MINOR_CIV_QUEST_SPREAD_RELIGION
#define QUEST_TRADE_ROUTE MINOR_CIV_QUEST_TRADE_ROUTE
